                ...
                <form method="POST" id="viewBallotForm" action="submit_ballot.php">
                  ...
                  while($row = mysqli_fetch_array($getBallotResult, MYSQLI_ASSOC)){
                    ...
                    <div class="col-md-4 text-center">
                      ...
                      data-placement="left" title="Click me to vote"><a>
                          <div class="row">
                            <div class="col-12">
                              <div class="view overlay">
                                <img class="img-thumbnail" src="'.$image.'">
                                <a><div class="mask rgba-'.$color.'-strong"><br>
                                  <h3 class="font-weight-bold Black-text">'.$crow['party'].'</h3><br>
                                  <h2 class="font-weight-bold Black-text"><strong>"'.$crow['nickname'].'"</strong></h2>
                                </div></a>
                              </div>
                            </div>
                          </div>
                          <h5 class="'.$color.'-text"><strong>'.$crow['firstname'].' '.$crow['lastname'].'</strong></h5>
                          '.$input.'
                      </label></a>
                    </div>';
                    }
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer justify-content-center">
        <a type="button" class="btn btn-outline-primary waves-effect" data-dismiss="modal">No</a>
          <button type="submit" class="btn btn-outline-warning waves-effect" name="vote"><i class="fa fa-check-square-o"></i>Yes</button>
        </form>
      </div>
    </div>
    <!--/.Content-->
