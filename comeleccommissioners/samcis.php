...
<table class="table table-bordered" cellspacing="0" width="100%">
          ...
          <tbody>
            <?php
            $result3 = mysqli_query($conn, "SELECT * FROM positions join candidates on candidates.position_id = positions.id where department = 'SAMCIS'");
